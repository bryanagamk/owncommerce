...
func RegisterRoutes(app *fiber.App, h Handlers, m Middlewares) {
	...
	storefront.Patch("/me", m.Customer.Require(), h.Storefront.UpdateCustomerMe)
	...
	storefront.Patch("/addresses/:id", m.Customer.Require(), h.Storefront.UpdateAddress)
	storefront.Delete("/addresses/:id", m.Customer.Require(), h.Storefront.DeleteAddress)
